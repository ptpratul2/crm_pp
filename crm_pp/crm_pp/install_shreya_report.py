...
def install_shreya_report():
	"""Install Daily Leads Report-Shreya"""
	
	report_name = "Daily Leads Report-Shreya"
	...
	try:
		...
		print(f"   Features: Grouping by Status, Subtotals, Summary Statistics")
