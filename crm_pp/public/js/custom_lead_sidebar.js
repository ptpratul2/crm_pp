...
prompt_crm_navbar.initNavbar = function () {
    ...
    try {
        ...
        const items = [
             { label: "Dashboard", route: ["dashboard-view", "CRM"], icon: "dashboard" },
            { label: "Leads", route: ["List", "Lead"], icon: "user-plus" },
            { label: "Opportunity", route: ["List", "Opportunity"], icon: "briefcase" },
            { label: "Customers", route: ["List", "Customer"], icon: "building" },
            { label: "Contacts", route: ["List", "Contact"], icon: "address-card" },
            { label: "Reports", route: ["List", "Report"], icon: "file-alt" }
        ];
